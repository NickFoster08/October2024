...
# Load the SNP Excel file (adjust the filename to your actual file)
snp_df = pd.read_excel('/scratch/nf26742/BovMor1/fastqs/VCF_Files/all_vcf/all_vcf_sorted_table-2024-11-18_16-27-19.xlsx')

# Load the GFF3 file for gene annotations
gff3_file = '/scratch/nf26742/BovMor1/fastqs/sequence.gff3'

# Load the GFF3 file into a DataFrame (you can use pandas read_csv or custom parsing for GFF3)
# In this case, we assume the GFF3 file has columns like: seqid, source, type, start, end, attributes
